...
df = pd.DataFrame(data.DataReader('BSE/BOM500696', 'quandl', start=start, end=end ))  #HINDUSTAN_UNILEVER_LTD
df.to_dense().to_csv("HINDUSTAN_UNILEVER_LTD_DF.csv", index = False, sep=',', encoding='utf-8')
