...
df = pd.DataFrame(data.DataReader('BSE/BOM533519', 'quandl', start=start, end=end ))  #L&T Finance Holdings Ltd.
df.to_dense().to_csv("L&T Finance Holdings Ltd.DF.csv", index = False, sep=',', encoding='utf-8')
